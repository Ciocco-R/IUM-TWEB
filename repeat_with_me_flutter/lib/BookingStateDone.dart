...
class BookingStateDone extends StatefulWidget{
  BookingStateDone();

  @override
  _BookingStateDone createState() => _BookingStateDone();
}

class _BookingStateDone extends State<BookingStateDone>{
  List bookings = [];
  late List data;
  ...
  void changeBookingStateToDone(String teacherName, teacherSurname, courseTitle, day, hour, state) async{
  ...
  Widget build(BuildContext context){
    return Scaffold(
      appBar: AppBar(
        title: Text("Effettua una ripetizione"),
        actions: <Widget>[
          /*IconButton(
            onPressed: (){
              ...
              .map(
                (e) => DataRow(
                  ...
                  /*onSelectChanged: (selected){
                    print('selected row');
                    changeBookingStateToDone(e['teacherName'], e['teacherSurname'],e['courseTitle'], e['day'], e['hour'], e['state']);
                    setState((){
                      bookings.remove(e);
                    });
                  }*/
  ...
  showAlertDialog(BuildContext context, dynamic e) {
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: Text("Vuoi segnare la ripetizione selezionata come effettuata?"),
      actions: [
        cancelButton,
        continueButton,
      ],
