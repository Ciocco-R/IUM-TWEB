...
class BookingStateDeletedAdmin extends StatefulWidget{
  BookingStateDeletedAdmin();

  @override
  _BookingStateDeletedAdmin createState() => _BookingStateDeletedAdmin();
}

class _BookingStateDeletedAdmin extends State<BookingStateDeletedAdmin>{
  List bookings = [];
  late List data;

  void getMyOwnBookings() async{
    print("Entro in getAllBookings");
    var url = "http://localhost:8081/RepeatWithMe_war_exploded/servlet-all-booking";
